...
if (!isset($_SESSION["company_logged_in"]) || !isset($_SESSION["company"])) {
...
// Load the new database system from python_shared
require_once SHARED_PATH . '/database/AdModel.php';
$adModel = new AdModel();

// Load NEW AI/ML Moderation Service Client from moderator_services
...
function processImageThroughPipeline($inputPath, $outputPath, $moderationClient = null) {
    ...
    $pythonScript = MODERATOR_SERVICES_PATH . '/process_image_cli.py';
