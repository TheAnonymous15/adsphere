...
<header class="fixed top-0 left-0 w-full z-50 backdrop-blur-xl bg-white/10 border-b border-white/20 shadow-lg">
    <nav class="max-w-7xl mx-auto px-6 flex items-center justify-between h-20">
        ...
        <div class="hidden md:flex items-center space-x-8">
            ...
            <a href="/company/login.php" class="px-5 py-2.5 border border-white/70 text-white rounded-xl font-semibold hover:bg-white hover:text-indigo-700 transition-all hover:-translate-y-0.5">Login</a>
        </div>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white/20 backdrop-blur-lg border-t border-white/10 shadow-xl">
        ...
        <a href="/company/login.php" class="mobile-link font-semibold text-indigo-600">Login</a>
    </div>
</header>
        ...
        <div class="flex flex-col justify-between h-full gap-8">
            ...
            <div class="space-y-6 text-center md:text-left">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start mt-6">
                    ...
                    <a href="/company/login.php" class="px-6 py-3 border border-white text-white rounded-xl font-semibold hover:bg-white hover:text-indigo-600 transition transform hover:-translate-y-1">
                        Post Your Ad
                    </a>
                </div>
            </div>
