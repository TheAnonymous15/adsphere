...
async function loadUsersData() {
    ...
    try {
        ...
        // TODO: Create /api/admin/get_users.php endpoint
...
async function suspendCompany(companySlug) {
    ...
    try {
        ...
        const response = await fetch('/api/update_company_status.php', {
            method: 'POST',
            body: formData
        });
...
async function loadDevicesData() {
    ...
    try {
        ...
        const response = await fetch('/api/user_profiling.php');
        const data = await response.json();
...
async function loadAdStatusStats() {
    try {
        const res = await fetch('/api/ad_status_stats.php');
...
async function loadViolations() {
    try {
        const [violationsRes, statsRes] = await Promise.all([
            fetch('/api/moderation_violations.php?action=list&status=pending'),
            fetch('/api/moderation_violations.php?action=stats')
        ]);
...
async function takeViolationAction(violationId, actionType, adId) {
    ...
    try {
        ...
        const res = await fetch('/api/moderation_violations.php', {
            method: 'POST',
            body: formData
        });
...
async function runNewScan() {
    ...
    try {
        const res = await fetch('/api/scanner.php?action=scan');
        const data = await res.json();
