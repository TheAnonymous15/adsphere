...
async def _load_ads_for_scanning(
    ...
    try:
        ...
        # Adjust this path to your actual ads storage within python_system
        ads_base_path = Path(__file__).parent.parent.parent.parent.parent.parent / "python_shared" / "data" / "companies"

        if not ads_base_path.exists():
            # Try alternative path within python_system
