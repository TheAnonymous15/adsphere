            ...
            if (!$rateCheck['allowed']) {
                ...
                if ($authenticated && $companyData) {
                    ...
                    if ($remember) {
                        ...
                        file_put_contents("$metaBase/" . basename($file), json_encode($companyData, JSON_PRETTY_PRINT));
                    }
...
<div class="max-w-md w-full">
    ...
    <div class="bg-white/10 backdrop-blur-lg p-8 rounded-2xl shadow-2xl border border-white/20">
        ...
        <div class="mt-6 text-center text-sm text-gray-400">
            ...
            <a href="/app/admin/company_register.php" class="text-indigo-400 hover:text-indigo-300 font-medium">
                Register here
            </a>
        </div>
