...
switch ($apiPath) {
    ...
    case 'admin_stats':
        ...
        require BASE_PATH . '/services/api/admin_stats.php';
        break;
    ...
    case 'companies':
    case 'get_companies':
        require BASE_PATH . '/services/api/get_companies.php';
        break;
    ...
    case 'scanner/run':
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            require BASE_PATH . '/services/api/scanner.php';
        } else {
    ...
    case 'moderation_violations':
        ...
        require BASE_PATH . '/services/api/moderation_violations.php';
        break;
    ...
    case 'moderation/action':
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($adId && $action) {
                ...
                $logFile = BASE_PATH . '/services/admin/logs/moderation_' . date('Y-m-d') . '.log';
                $logEntry = [
                    'timestamp' => date('c'),
