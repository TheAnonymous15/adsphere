        ...
        <div class="glass-card rounded-2xl p-6 mb-12">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="/admin/moderation_dashboard.php" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 rounded-lg transition text-sm">
...
async function loadUsersData() {
    ...
    try {
        ...
        // TODO: Create /api/admin/get_users endpoint
...
async function loadDevicesData() {
    ...
    try {
        ...
        const response = await fetch('/api/user_profiling');
        const data = await response.json();
...
async function loadAdStatusStats() {
    try {
        const res = await fetch('/api/ad_status_stats');
...
async function loadViolations() {
    try {
        const [violationsRes, statsRes] = await Promise.all([
            fetch('/api/moderation_violations?action=list&status=pending'),
            fetch('/api/moderation_violations?action=stats')
        ]);
...
async function takeViolationAction(violationId, actionType, adId) {
    ...
    try {
        ...
        const res = await fetch('/api/moderation_violations', {
            method: 'POST',
            body: formData
        });
...
async function runNewScan() {
    ...
    try {
        const res = await fetch('/api/scanner?action=scan');
        const data = await res.json();
