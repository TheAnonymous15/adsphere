...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-slate-800/50 backdrop-blur rounded-2xl p-8 border border-white/10">
        ...
        <form method="POST" action="/handlers/update_ad.php" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <div class="bg-slate-900 rounded-lg p-4 border border-gray-600">
                    <?php
                    $mediaPath = "/services/company/data/$adCategory/$companySlug/$adId/" . ($adData['media'] ?? '');
