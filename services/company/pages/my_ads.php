...
async function loadAds() {
    try {
        const [adsRes, analyticsRes] = await Promise.all([
            fetch(`/services/api/get_ads.php?company=${encodeURIComponent(companySlug)}`),
...
async function loadMyAdsContactAnalytics() {
    ...
    try {
        const response = await fetch(`/services/api/contact_analytics.php?days=${dateRange}`);
...
async function confirmDelete() {
    ...
    try {
        ...
        const response = await fetch('/services/api/delete_ad.php', {
            method: 'POST',
            headers: {
...
async function toggleStatus(adId, currentStatus) {
    ...
    try {
        const response = await fetch('/services/api/update_ad_status.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function duplicateAd(adId, title) {
    ...
    try {
        const response = await fetch('/services/api/duplicate_ad.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function confirmSchedule() {
    ...
    try {
        const response = await fetch('/services/api/schedule_ad.php', {
            method: 'POST',
...
async function viewAnalytics(adId) {
    try {
        const response = await fetch(`/services/api/get_analytics.php?ad_id=${adId}`);
        const result = await response.json();
