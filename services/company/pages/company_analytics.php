<?php
/********************************************
 * Company Analytics Dashboard - AdSphere
 * Analytics and statistics for company's own ads
 * NOTE: This is for COMPANY users, not platform admins
 * Platform admin dashboard is at: /app/admin/admin_dashboard.php
 ********************************************/
session_start();

// Block unauthorized access - Company login required
...
<head>
    ...
    <title>Company Analytics - <?= htmlspecialchars($companyName) ?> - AdSphere</title>
