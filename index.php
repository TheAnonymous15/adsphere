...
<head>
    ...
    <title>AdSphere - Landing Page</title>
...
<nav class="w-full bg-gradient-to-r from-indigo-500 to-pink-500  shadow-sm fixed top-0 z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
        <!-- Logo -->
        <h1 class="text-2xl font-bold text-indigo-600">AdSphere</h1>

        <!-- Desktop Menu -->
        <div class="hidden md:flex space-x-6 items-center">
            <a href="#features" class="text-gray-700 hover:text-indigo-600 transition">Features</a>
            <a href="#marketplace" class="text-gray-700 hover:text-indigo-600 transition">Marketplace</a>
            ...
            <a href="#signup" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition">Signup</a>
            <a href="#login" class="px-4 py-2 border border-indigo-600 text-indigo-600 rounded-lg hover:bg-indigo-50 transition">Login</a>
        </div>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white shadow-md">
        <a href="#features" class="block px-4 py-2 text-gray-700 hover:bg-indigo-50">Features</a>
        <a href="#marketplace" class="block px-4 py-2 text-gray-700 hover:bg-indigo-50">Marketplace</a>
        <a href="#pricing" class="block px-4 py-2 text-gray-700 hover:bg-indigo-50">Pricing</a>
        <a href="#testimonials" class="block px-4 py-2 text-gray-700 hover:bg-indigo-50">Testimonials</a>
        <a href="#faq" class="block px-4 py-2 text-gray-700 hover:bg-indigo-50">FAQ</a>
        <a href="#signup" class="block px-4 py-2 text-indigo-600 font-semibold hover:bg-indigo-50">Signup</a>
        <a href="#login" class="block px-4 py-2 text-indigo-600 font-semibold hover:bg-indigo-50">Login</a>
    </div>
...
<!-- Hero Section -->
<section class="relative bg-gradient-to-r from-indigo-500 to-pink-500 text-white">
    <div class="max-w-7xl mx-auto px-6 py-24 flex flex-col-reverse md:flex-row items-center gap-12">
        <!-- Text Content -->
        <div class="flex-1 text-center md:text-left">
            <h1 class="text-5xl md:text-6xl font-extrabold mb-4 leading-tight">The Future of Digital Advertising</h1>
            <p class="text-xl md:text-2xl mb-6 text-indigo-100">Create, manage, and deploy ads with AI-powered automation. Upload once, generate multiple formats, and scale performance automatically.</p>
            
            <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start mt-6">
                <a href="#signup" class="px-6 py-3 bg-white text-indigo-600 font-semibold rounded-xl hover:bg-indigo-50 transition">Get Started</a>
                <a href="#features" class="px-6 py-3 border border-white text-white rounded-xl hover:bg-white hover:text-indigo-600 transition">Learn More</a>
            </div>

            <div class="mt-10 flex justify-center md:justify-start gap-8 text-sm text-indigo-100">
                <div><span class="font-bold">+12k</span> Ads Created</div>
                <div><span class="font-bold">65%</span> Avg Performance Boost</div>
                <div><span class="font-bold">$2.4M</span> Ad Spend Optimized</div>
            </div>
        </div>

        <!-- Hero Mockup -->
        <div class="flex-1 flex justify-center md:justify-end">
            <div class="w-full max-w-lg bg-white rounded-3xl shadow-2xl p-6">
                <div class="h-72 bg-gradient-to-br from-gray-100 to-white rounded-2xl flex items-center justify-center">
                    <span class="text-gray-400 text-center">Hero Mockup / Video Preview</span>
                </div>
                <div class="mt-4 grid grid-cols-3 gap-3">
                    <div class="h-16 bg-gray-50 rounded-lg flex items-center justify-center text-xs text-gray-400">Frame 1</div>
                    <div class="h-16 bg-gray-50 rounded-lg flex items-center justify-center text-xs text-gray-400">Frame 2</div>
                    <div class="h-16 bg-gray-50 rounded-lg flex items-center justify-center text-xs text-gray-400">Frame 3</div>
                </div>
            </div>
        </div>
    </div>
...
<!-- CTA Section -->
<section id="cta" class="py-24 bg-gradient-to-r from-indigo-500 to-pink-500 text-white text-center relative overflow-hidden">
    <!-- Optional decorative background shapes -->
    <div class="absolute inset-0 bg-black/20 pointer-events-none"></div>

    <div class="relative max-w-3xl mx-auto px-6">
        <h3 class="text-4xl sm:text-5xl font-bold mb-4">Ready to Supercharge Your Ads?</h3>
        <p class="text-lg sm:text-xl mb-8 text-gray-100">Start your free trial today and experience AI-powered ad automation.</p>
        <button class="px-8 py-4 bg-white text-indigo-600 font-semibold rounded-full shadow-lg hover:scale-105 transform transition duration-300">
            Get Started
        </button>
    </div>
</section>
